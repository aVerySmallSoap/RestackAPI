...
def summarize_with_ai(session: str) -> dict:
    ...
    with open(report_path, "r") as f:
        try:
            report = json.load(f)
            _data = {
                "union": report["data"]["union"],
                "intersection": report["data"]["intersection"],
                "rules": report["data"]["rules"],
            }
            _tech = {
                "fingerprinted": report["plugins"]["fingerprinted"],
                "patchable": report["plugins"]["patchable"],
            }
            ...
            vuln_response = ai_client.models.generate_content(
                ...
                contents=[
                    "Can you summarize the findings in this report.",
                    "Can you recommend solutions on how to mitigate these problems",
                    json.dumps(_data),
                ],
            )
            ...
            tech_response = ai_client.models.generate_content(
                ...
                contents=[
                    "Can you summarize the findings in this report.",
                    "If there are problems, can you recommend solutions to mitage them",
                    json.dumps(_tech),
                ],
            )
